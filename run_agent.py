        ...
        if "http_client" not in client_kwargs:
            try:
                ...
                if _base_url and is_local_endpoint(_base_url):
                    # Local providers must bypass ambient proxy/VPN variables.
                    # Otherwise httpx can route 127.0.0.1 traffic through a
                    # proxy and convert a healthy local endpoint into a 502.
                    _trust_env = False
